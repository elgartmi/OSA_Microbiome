...
save(MainModel_res,file = paste0("/data/linkage/HCHS_SOL/Projects/2021_OSA_microbiome/Results/MainModel_",rnstr,"_v2.RData"))

#######################################################################################
####################### extended model - Lifestyle
#######################################################################################
...
save(ExtendedModel_res,file = paste0("/data/linkage/HCHS_SOL/Projects/2021_OSA_microbiome/Results/ExtendedModel_Lifestyle_",rnstr,"_v3.RData"))
...
#save
save(ExtendedModelDiabetesObesityDiet_res,file = paste0("/data/linkage/HCHS_SOL/Projects/2021_OSA_microbiome/Results/ExtendedModel_Lifestyle_Comorbidities_",rnstr,"_v3.RData"))
